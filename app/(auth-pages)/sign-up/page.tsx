          ...
          <form action={googleSignInAction} className="flex-1">
            ...
            >
              ...
              >
                ...
                />
                <path
                  d="M5.84 14.13c-.22-.69-.35-1.42-.35-2.13s.13-1.44.35-2.13V7.03H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.97l2.66-2.84z"
                  fill="#FBBC05"
                />
                <path
                  d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.46 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.03l3.66 2.84c.86-2.59 3.29-4.53 6.16-4.53z"
                  fill="#EA4335"
                />
              </svg>
              Google
